...
// or implement manually if Boost version is too old or for no Boost dependency here.
// For simplicity, assuming standard POSIX/Windows availability of htonl/ntohl
